...
- vérifier qu’un appui sur un événement Calendar déplie ses détails sans afficher de bouton « Description » ;
- vérifier que la météo horaire démarre à l’heure actuelle, ne coupe aucune carte au bord et défile jusqu’aux 24 prochaines heures ;
